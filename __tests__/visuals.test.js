 ...
 * - Eightball redirects
 * - Settings appear on screen
 * - Mute/Unmute button
 */
describe('UI Tests', () => {
	beforeEach(beforebefore);

	it('Pressing anywhere on screen removes splash screen', async () => {
		await loadPagePastSplashScreen(URL_2D);
		await testSplashScreen(URL_2D);
	}, 0);

	it('Pressing on eight ball redirects to Magic 8 Ball', async () => {
		await loadPagePastSplashScreen(URL_2D);
		await testEightBall();
	}, 0);

	it('Pressing settings button makes menu appear on screen', async () => {
		await loadPagePastSplashScreen(URL_2D);
		await testSettingsMenuSliding();
	});

	it('Test mute/unmute button', async () => {
		await loadPagePastSplashScreen(URL_2D);
		await clickSettingsButton();
...
describe('User flow Tests', () => {
	...
	it('Generate ticket, save, then delete Ticket', async () => {
		await loadPagePastSplashScreen(URL_2D);
	...
	it('Generate ticket, then discard it', async () => {
		await loadPagePastSplashScreen(URL_2D);
		await generateMainTicket();
	...
	it('Opens settings then toggle credits ticket', async () => {
